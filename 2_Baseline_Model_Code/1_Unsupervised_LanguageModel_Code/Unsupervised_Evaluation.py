...
# Thresholds 
for endpoint, _ in enumerate(all_words_probability_with_modified):
	if endpoint > 0:
		num_rep_words = 0
		num_all_words = 0
		f1 = 0
...
with open("results/baseline_processed_unsupervised_"+lr+"_"+generation,'w') as f:
	f.write("{}\n".format(sentence_level_perplexity))
	f.write("{}\n".format(""))

	for element in f1_score_per_threshold:
		content = element[0] + ";" + element[1] + ";" + element[2] + ";" + element[3] + ";" + element[4]
		f.write("{}\n".format(content))
